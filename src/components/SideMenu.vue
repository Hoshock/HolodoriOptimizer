 ...
 * ホロメンボード / ペルソナ風UI。折り畳みは最初は畳み、開くと一段下げた項目(アイコン + 内容)が出て、その位置より下の行が下へ動く
  ...
  >
    ...
    <nav class="drawer" aria-label="メニュー" :inert="!props.open">
      <ul class="items">
        ...
        <!-- 3 つめのグループ「開発用」(折り畳み。最初は畳む): GitHub / カラー確認 / ホロメンボード / ペルソナ風UI。アイコンはコードの括弧 -->
        <li>
          <button
            type="button"
            class="item"
          ...
          <div :id="`group-dev`" class="fold" :class="{ open: groups.dev }">
            <ul class="sub-items" :inert="!groups.dev">
              ...
              <li>
                <a class="sub-item" href="./persona-ui/?view=main">
                  <!-- ペルソナ風UI: 斜めに切ったカードを2枚重ねた抽象アイコン。公式素材は使わない -->
                  <svg
                    class="item-icon"
                    viewBox="0 0 24 24"
                    width="24"
                    ...
                    aria-hidden="true"
                  >
                    <path d="M5 7.5 18 4l1 9.5-13 3.5z" />
                    <path d="M4 11.5 17 8l2 10.5-13 1.5z" />
                    <path d="m8 13 5-1.5" />
                  </svg>
                  <span>ペルソナ風UI</span>
                </a>
