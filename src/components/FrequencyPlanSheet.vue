      ...
      <div class="body">
        ...
        <div class="footnotes">
          ...
          <p>
            ...
            <span
              >「現在」はいま登録しているボードでの発動頻度、「推奨」はその案が勧める値です。推奨が現在より多ければその差のマスを開け、少なければ外します（ホロメンボードのマスは外せて、素材も返ってきます）。表に並ぶのは、いま登録しているボードから実際に到達できる状態（頻度のマスまでの経路も解放する前提）だけです。経路は追加するマスが最少のものだけを見ているので、遠回りして
