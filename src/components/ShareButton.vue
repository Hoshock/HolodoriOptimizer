 ...
 * 箱は正方形に近い縦長で、矢印の縦棒は箱の中から上へ抜ける（矢じりは上辺から離す）。大きさは隣の星（42px）に近づけてある（26px は「小さい」— 2026-09-15）。
  ...
  >
    ...
    >
      <template v-if="!props.copied">
        <!--
          矢印の縦棒は箱の中から出る（2026-09-15 ユーザー指示）。上辺の切れ目より広く取らず、
          矢じりは上辺から離して置く（近いと橋が架かって見える — 同日）
        -->
        <path d="M12 15V2" />
