 ...
 *   2026-09-12 に 1凸の値を仮定倍率の 10.9 から抽出マスターの Lv1 = 9% に訂正したことで 0.2 ずつ広がった。実機 2.4〜3.5 に対し
 ...
 * 恒常マリン 1凸のパッシブ(3期生 2 人のスコアサポート、開花最大 12%)は 2026-09-12 に抽出マスターの Lv1 = 9% を
...
describe("表示スコアボーナスのゴールデンケース(2026-09-08 実機 20 ケース)", () => {
  ...
  it("20 ケースの実機との誤差が現在の範囲に収まる(悪化の検知。この値に合わせ込むためのテストではない)", () => {
    ...
    // パッシブは 2026-09-12 に恒常マリン 1凸のパッシブを仮定倍率 10.9 → 抽出マスター Lv1 = 9% に訂正したことで 1.6 → 1.8(9.10)へ
