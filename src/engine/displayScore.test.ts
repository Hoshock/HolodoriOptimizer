...
const golden: [string, Row, Row][] = [
  ...
  ["9.8", [63.7, 13.9, 3.0, 38.6, 119.2, 1106433], [63.7, 13.6, 3.2, 38.6, 119.1, 1105928]],
  ["9.9", [68.8, 12.1, 2.9, 41.7, 125.5, 1148188], [68.8, 12, 3.1, 41.7, 125.6, 1148697]],
  ["9.10", [70.4, 14.3, 3.5, 42.1, 130.3, 1133037], [70.4, 14.3, 3.5, 42.1, 130.3, 1133037]],
  ["9.11", [75.6, 12.5, 2.4, 45.2, 135.7, 1191293], [75.6, 12.4, 2.6, 45.2, 135.8, 1191798]],
...
describe("赤スコアサポート +10 の 水着ノエル 0凸 入替(2026-09-11 実機観測。固定 0.88 × X を棄却した対照)", () => {
  ...
  const modelRows: Row[] = [
    ...
    [78.9, 25.1, 2.1, 46.3, 152.4, 1323229],
  ];
...
describe("赤スコアサポート +10 の 3 編成目(2026-09-12 実機観測、水着フワワ 0凸入り。実機 +8.7)", () => {
   ...
   */
  const modelRows: Row[] = [
    [77.9, 18.6, 0.9, 47.2, 144.6, 1304757],
