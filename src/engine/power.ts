 ...
 * 合計で 2 点ずれる(pending.md「赤割合効果の丸め単位」)。
 *
 * 2026-09-11 の実機観測(同じ 5 人・同じリーダー(水着ミオ)で曲だけを変え、赤の歌唱者条件を OFF / ON にした 2 点。
 * docs/human/repro/display-score-20260908-11.md「2026-09-11: 赤の歌唱者条件」)で追加で確定・判明したこと:
 ...
 *   それぞれ切り上げた差)は +12,253(+2)。素値の ±1 の不確かさ(pending.md「赤割合効果の丸め単位」)をどう振っても +12,252〜+12,255 で、
 ...
 *   100〜120 点足りない — 内訳からの逆算とアカウント画面が一致した(docs/human/repro/display-score-20260908-11.md「観測時点のアカウント値」)
 *
...
/** アカウント共通の補正(ゲーム内表示の % をそのまま。現在値は docs/human/repro/display-score-20260908-11.md「観測時点のアカウント値」) */
