 ...
 * - 【逆算(未確認)】強化ボーナスの実機値(8,787 / 9,154、黄の観測の 7,306)は基準(メモリー抜きの合計)の 3.00% に
 *   メンバーごとの切り上げで整合し、2026-09-08 時点の 2.96% では 100〜120 点足りない。アカウントの現在値は
 *   ゲーム画面で確認してもらう(status.md の「アカウント共通値」)
 *
