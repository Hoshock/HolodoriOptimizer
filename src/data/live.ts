 ...
 * 2026-09-08 の引き継ぎで「外部コミュニティ解析の有力値は 高 55% / 中 45% / 低 35%」と共有されたのでそれに置き換えた
 * (以前の 25 / 50 / 75 は根拠のない仮置き)。実機では未確認 — 実機のユニットスコア詳細「アクティブスキル 77.0%」を
 * 単純な周期 × 確率 × 効果時間のモデルで再現する試みは決め手に欠けた(docs/ai/tmp/pending.md の 6)
 */
